...
describe("E2E - Zakup diety lowcarb_solo", () => {
    it("Proces zakupu", () => {
        ...
        //Kliknięcie w zakłądkę Low Carb
        cy.get('[class="type-of-diet"]')
        .find("a")
        .should('have.length', 2)
        .eq(1)
        .click();
        ...
        cy.get(':nth-child(3) > .JS-with-dietitian.button-bordered')
        ...
        cy.get("#login").type("testowe_keto_lowcarb");
